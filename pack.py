...
with open(headerPart, 'wb') as header:
	...
	header.write('# Device : synsepalum_R\n'.encode())
	header.write('# Build PATH : /studio3/jenkins/workspace/Z6_Z6X/126_2019-04-17-115933/android\n'.encode())
	header.write('# Build TIME : 2019-04-17 13:16:27\n'.encode())
	header.write('# Build TIME STAMP : 1555478187\n'.encode())
